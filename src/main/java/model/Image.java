...
public final class Image {
    ...
    private Image(String imagePath) {
        ...
        IntBuffer comp1 = BufferUtils.createIntBuffer(1);
        imageBuffer = stbi_load("src/main/resources/font1.png", width, height, comp1, 4);
        ...
        try (MemoryStack stack = stackPush()) {
            ...
            if (!stbi_info_from_memory(imageBuffer, width, height, comp1)) {
                throw new RuntimeException("Failed to read image information: " + stbi_failure_reason());
            } else {
                System.out.println("OK with reason: " + stbi_failure_reason());
            }

            System.out.println("model.Image width: " + w.get(0));
            System.out.println("model.Image height: " + h.get(0));
            System.out.println("model.Image components: " + comp.get(0));
            System.out.println("model.Image HDR: " + stbi_is_hdr_from_memory(imageBuffer));
    ...
    public static void main(String[] args) {
        String imagePath;
        if (args.length == 0) {
            System.out.println("Use 'ant demo -Dclass=org.lwjgl.demo.stb.model.Image -Dargs=<path>' to load a different image.\n");
    ...
    private void init() {
        ...
        this.window = glfwCreateWindow(ww, wh, "STB model.Image Demo", NULL, NULL);
        if (window == NULL) {
        ...
        //glfwInvoke(window, this::windowSizeChanged, model.Image::framebufferSizeChanged);
    }
